                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" id="type" name="type">
                                                <option value="SmartFPS">Smart FPS</option>
                                                <option value="NonSmartFPS">Non-Smart FPS</option>
                                            </select>
                                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                            <input type="text" class="form-control" id="demand" name="demand"
                                                value="<?php echo $demand ?>" required />
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                            <input type="text" class="form-control" id="demand_rice" name="demand_rice"
                                                value="<?php echo $demand_rice ?>" required />
                                        </div>
                                        <span class="help-block">Demand in Quintals</span>
                                    </div>
                                </div>
