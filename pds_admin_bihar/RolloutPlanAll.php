...
<style>
	    ...
	    .loader {
            ...
            display: none; /* Changed to flex for centering text */
	...
	function fetchTableDataFromServer(){
		...
		else
		{
			...
			$.ajax({
				type: "POST",
				url: "api/FetchTableRolloutPlanAll.php",
				data: dataString,
				cache: false,
				error: function(){
					alert("timeout");
				...
				success: function(result){
					...
					try{
						...
						if(type=="rice_fci_wheat_fci"){
							...
							cell2.innerHTML = "110,436,748";
							cell3.innerHTML = "34,29,833";
							cell4.innerHTML = "2413336394";
							cell5.innerHTML = "21.853";
	...
	setTimeout(fetchTableDataFromServer, 3000);
